...
namespace Pulumi.Railway
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Railway.version.txt");
    ...
    internal sealed class RailwayResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RailwayResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
